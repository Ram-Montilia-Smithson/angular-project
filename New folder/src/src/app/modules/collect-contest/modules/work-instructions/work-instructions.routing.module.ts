...
const routes: Routes = [
  {
    ...
    children: [{ path: '', component: CollectContestWorkInstructionsComponent }],
  },
];
...
@NgModule({
  ...
  providers: [{ provide: MODULE_PREFIX, useValue: 'work-instructions' }],
})
export class WorkInstructionsRoutingModule {}